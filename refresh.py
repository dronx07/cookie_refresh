...
PROXY = {"server": "dc.oxylabs.io:8000", "username": "Maze54_hytBx", "password": "y8OP0IwvQ8e7H+"}


def fetch_amazon_cookies(p):
    browser = p.chromium.launch(headless=True, args=["--disable-blink-features=AutomationControlled"], proxy=PROXY)
